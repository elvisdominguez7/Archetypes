...
import static ${package}.constants.ErrorFaults.CUSTOMER_ALREADY_EXIST_FAULT;
import static ${package}.constants.ErrorFaults.NO_CUSTOMER_FOUND_FAULT;
...
public class UserManagementServiceSO {
	...
	@Autowired
	private SampleServiceDaoImpl dao;
